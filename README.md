...
# Решение 1
1. Настроим интерфейс маршрутизатора 1 первой группы, изменим приоритетность на 95. В этом случае по умолчанию ping от сервера
будет проходить через роутер 2, так  как у него приоритет выставлен по умолчанию (100).
