...
Проверим доступность серверов nginx по всем 3-ем адресам.  
<img src = "img/2-7.png" width = 60%>     
<img src = "img/2-8.png" width = 60%> 
<img src = "img/2-9.png" width = 60%>

3. Создадим bash-скрипт, укажем его в конфигурационном файле Keepalived. После рестарта выявлено, что скрипт не запускается, так как файл не исполняемый, а ползователт не назначен.  
<img src = "img/2-10.png" width = 60%>
Дополним файл блоком глобальных настроек с указанием пользователя скрипта, а также помменяем права в скрипте.
...
4. Обратимся  к серверам nginx по всем 3-ем адресам, а затем для проверки удалим index.html с ВМ-Master
<img src = "img/2-14.png" width = 60%>
<img src = "img/2-15.png" width = 60%> 
<img src = "img/2-16.png" width = 60%><img src = "img/2-12.png" width = 60%> 
<img src = "img/2-17.png" width = 60%>

5. Использованы следующие файлы конфигурации и скрипта.
